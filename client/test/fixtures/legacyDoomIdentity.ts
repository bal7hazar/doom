/** Exact identity from the pre-calculation-pass real UI refusal export (0c8a3a8).
 * Keep frozen: this is a migration rejection fixture, never a current pin. */
export const legacyDoomIdentity = {
