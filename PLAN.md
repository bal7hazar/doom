...
| A7 | **Arithmétique felt-first** en Cairo : add/mul sur felt252, réductions et comparaisons explicites aux frontières. Révisé après S0 : felts négatifs et builtin bitwise sont **prouvables** ; règle de **coût** : garder les valeurs en mémoire < 2^72 quand c'est gratuit (au-delà, +33 % sur un composant range-check), et éviter les masques bitwise (57 steps/itération contre 14 en felt pur). | Mesures §4.3 et S0. |
