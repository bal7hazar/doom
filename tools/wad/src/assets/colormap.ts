...
export function parseColormap(buffer: Uint8Array): Colormap {
  ...
  return { mapCount, maps, data: buffer.slice() };
}
 ...
 *
 * which is what a fragment shader would evaluate per pixel. This function is
 * the CPU twin, used by the automap and by the unit tests.
 */
