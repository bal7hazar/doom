use bounded_int_ref::{BoundedInt, DivRemHelper, div_rem, upcast};
pub use stwo_verifier_utils_ref::M31_SHIFT;
...
impl U32TryIntoM31 of TryInto<u32, M31> {
    ...
    fn try_into(self: u32) -> Option<M31> {
        match bounded_int_ref::constrain::<u32, P>(self) {
...
impl M31ConstrainHelper of bounded_int_ref::ConstrainHelper<u32, P> {
    type LowT = M31InnerT;
