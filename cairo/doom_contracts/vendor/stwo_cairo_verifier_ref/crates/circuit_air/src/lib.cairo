//! `stwo_circuit_air_ref`: AIR-specific verifier-side logic written in Cairo for the stwo-circuits
//! circuit.
...
use stwo_constraint_framework_ref::LookupElementsImpl;
pub use stwo_constraint_framework_ref::{RelationUse, RelationUsesDict, accumulate_relation_uses};
use stwo_verifier_core_ref::Hash;
use stwo_verifier_core_ref::channel::{Channel, ChannelTrait};
use stwo_verifier_core_ref::fields::m31::{M31Trait, P_U32};
#[cfg(not(feature: "poseidon252_verifier"))]
use stwo_verifier_core_ref::fields::qm31::QM31Trait;
use stwo_verifier_core_ref::fields::qm31::{QM31, QM31Serde};
use stwo_verifier_core_ref::pcs::PcsConfigTrait;
use stwo_verifier_core_ref::pcs::verifier::CommitmentSchemeVerifierImpl;
use stwo_verifier_core_ref::utils::SpanExTrait;
use stwo_verifier_core_ref::verifier::{StarkProof, VerificationError, verify};
#[cfg(not(feature: "poseidon252_verifier"))]
use stwo_verifier_utils_ref::blake2s::hash_u32s;
...
/// `stwo_constraint_framework_ref::accumulate_relation_uses` already sums directly — the check
/// here is the plain `< P` bound on that accumulated `u64`.
pub fn verify_claim(component_log_sizes: PerComponent<u32>) {
