...
mod tests {
    ...
    fn test_evaluation_result() {
        ...
        let mut preprocessed_trace = preprocessed_mask_add(
            preprocessed_trace,
            BITWISE_XOR_4_0_IDX,
            qm31_const::<1700437256, 1297136628, 1235543940, 1503106128>(),
        );
        let mut preprocessed_trace = preprocessed_mask_add(
            preprocessed_trace,
            BITWISE_XOR_4_1_IDX,
            qm31_const::<1767546435, 1431354356, 1302652804, 1503106128>(),
        );
        let mut preprocessed_trace = preprocessed_mask_add(
            preprocessed_trace,
            BITWISE_XOR_4_2_IDX,
            qm31_const::<1566218898, 1028701172, 1101326212, 1503106128>(),
        );
