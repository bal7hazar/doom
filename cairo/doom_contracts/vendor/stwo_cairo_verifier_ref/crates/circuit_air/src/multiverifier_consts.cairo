...
use stwo_verifier_core_ref::fri::FriConfig;
use stwo_verifier_core_ref::pcs::PcsConfig;
...
// Generated by cairo/doom_contracts/tools/gen_multiverifier_consts.py from the circuit
// registry `doom` (multiverifier circuit_hash a5989715 2377c07a c6d1e844 54f0a04d 8be65a7d fd73c261 9078e728 973f680f).
