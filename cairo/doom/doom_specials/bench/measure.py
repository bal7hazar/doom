...
"""Step-cost and bytecode-budget test for `doom_specials`.
...
2. **Bytecode words.** `bench/size/` references every generated `const`
   ...
   `../scripts/gen_specials.py`) and checks that the analytic total and the
...
TOLERANCE = 1.10
DATA_WORD_BUDGET = 3000  # this crate's slice of docs/G0.md D4 / D23
