...
def main() -> int:
    ...
    # an array was dead-code-eliminated (benchmark no longer touches it) or
    # the emitter stopped costing one word per element.
    if abs(data_words - manifest["total_words"]) > 0.05 * manifest["total_words"]:
