...
plafonds de segments D26. La CI distante du nouveau build est verte (`34762719280`, commit `67014df`). Le garde runtime CI ajouté ensuite par `163c9e1` est aussi vert (`34764805318`), y compris les trois modes et les deux modules reconstruits. La matrice initiale ci-dessous conserve les essais avant correction.
